...
export class Element2Component implements OnInit {
  ...
  calc(ev) {
    ...
    if(name == 's1_unit' || name == 's2_unit' || name == 's3_unit' || name == 's1_density' || name == 's2_density' || name == 's3_density') {
      this.sUnit = s1_unit + s2_unit + s3_unit;
      this.sDensity = (this.sUnit/(s1_unit/s1_density + s2_unit/s2_density + s3_unit/s3_density)).toFixed(3);
    } else if(name == 'g1_unit' || name == 'g2_unit' || name == 'g3_unit' || name == 'g1_density' || name == 'g2_density' || name == 'g3_density') {
      this.gUnit = g1_unit + g2_unit + g3_unit;
      this.gDensity = (this.gUnit/(g1_unit/g1_density + g2_unit/g2_density + g3_unit/g3_density)).toFixed(3);
    } else if(name == 'ad1_unit' || name == 'ad2_unit' || name == 'ad3_unit' || name == 'ad1_density' || name == 'ad2_density' || name == 'ad3_density') {
      this.adUnit = ad1_unit + ad2_unit + ad3_unit;
      this.adDensity = (this.adUnit/(ad1_unit/ad1_density + ad2_unit/ad2_density + ad3_unit/ad3_density)).toFixed(3);
    }
