...
export class ResultComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.values.w2_unit = mixs[0].w1_unit;
    this.values.w2_density = mixs[0].w1_unit;
    this.values.w3_unit = mixs[0].w1_unit;
    this.values.w3_density = mixs[0].w1_unit;
    this.values.c1_unit = mixs[0].w1_unit;
    this.values.c1_density = mixs[0].w1_unit;
    this.values.c2_unit = mixs[0].w1_unit;
    this.values.c2_density = mixs[0].w1_unit;
    this.values.c3_unit = mixs[0].w1_unit;
    this.values.c3_density = mixs[0].w1_unit;
    this.values.mad1_unit = mixs[0].w1_unit;
    this.values.mad1_density = mixs[0].w1_unit;
    this.values.mad2_unit = mixs[0].w1_unit;
    this.values.mad2_density = mixs[0].w1_unit;
    this.values.mad3_unit = mixs[0].w1_unit;
    this.values.mad3_density = mixs[0].w1_unit;
