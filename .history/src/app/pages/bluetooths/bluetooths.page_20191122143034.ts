...
export class BluetoothsPage {
  ...
  checkConnection(seleccion) {
    this.bluetooth.checkConnection().then(async (isConnected) => {
      const alert = await this.alertCtrl.create({
        header: this.translate.instant('블루투스 재연결'),
        message: this.translate.instant('블루투스 재연결 하시겠습니까?'),
        buttons: [
          {
      ...
      const alert = await this.alertCtrl.create({
        header: this.translate.instant('블루투스 연결'),
        message: this.translate.instant('블루투스 연결 하시겠습니까?'),
        buttons: [
          {
            text: this.translate.instant('취소'),
            role: 'cancel',
  ...
  sendMessage(message) {
    ...
    this.bluetooth.printData(result.encode())
    .then((printStatus) => {
