...
export class DetailsPage implements OnInit {
  ...
  ionViewWillEnter(){
    ...
    this.getapi.measureResult(this.resultId).subscribe((res) => {
      ...
      console.log(NumberStr((this.results[0].w1_unit).toString(), 6));
      console.log(NumberStr((this.results[0].w1_density).toString(), 7));
      console.log(NumberStr((this.results[0].w2_unit).toString(), 6));
