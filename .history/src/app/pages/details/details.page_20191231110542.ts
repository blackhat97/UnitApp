...
export class DetailsPage implements OnInit {
  ...
  ionViewWillEnter(){
    ...
    this.getapi.measureResult(this.resultId).subscribe((res) => {
      ...
      const k1 = NumberStr((this.results[0].w1_unit).toString(), 6);
      const k2 = NumberStr((this.results[0].w1_density).toString(), 7);
      const k3 = NumberStr((this.results[0].w2_unit).toString(), 6);
