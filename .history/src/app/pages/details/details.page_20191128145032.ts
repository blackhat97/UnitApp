...
export class DetailsPage implements OnInit {
  ...
  prepareToPrint() {
   ...
   .codepage('cp949')
   .tableCustom([ 
    { text:"사업장", align:"LEFT", width:0.33 },
    { text:this.results[0].cname, align:"CENTER", width:0.66},
   ])
   .tableCustom([ 
    { text:"계약자", align:"LEFT", width:0.33 },
    { text:this.results[0].ct_name, align:"CENTER", width:0.66}
   ])
   .tableCustom([ 
    { text:"현장명", align:"LEFT", width:0.33 },
    { text:this.results[0].sname, align:"CENTER", width:0.66}
   ])
   .tableCustom([ 
    { text:"날짜", align:"LEFT", width:0.33 },
    { text:this.results[0].datetime, align:"CENTER", width:0.66}
   ])
   .newline()
   .newline()
   .newline()
