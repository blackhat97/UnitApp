...
export class DetailsPage implements OnInit {
  ...
  ionViewWillEnter(){
    ...
    this.getapi.measureResult(this.resultId).subscribe((res) => {
      ...
      console.log(NumberStr((this.results[0].w1_unit).toString(), 6) + NumberStr(this.results[0].w1_density, 7));
      console.log(NumberStr(this.results[0].w1_density, 7));
      console.log(NumberStr((this.results[0].w2_unit).toString(), 6) + NumberStr(this.results[0].w2_density, 7));
  ...
  prepareToPrint() {
   ...
   result
   .codepage('cp949')
   .line(NumberStr((this.results[0].w1_unit).toString(), 6) + NumberStr(this.results[0].w1_density, 7))
   .line(NumberStr((this.results[0].w2_unit).toString(), 6) + NumberStr(this.results[0].w2_density, 7))
   ...
   .line(NumberStr((this.results[0].w1_unit).toString(), 6) + NumberStr(this.results[0].w1_density, 7))
   .line(NumberStr((this.results[0].w2_unit).toString(), 6) + NumberStr(this.results[0].w2_density, 7))
   .line(NumberStr((this.results[0].w3_unit).toString(), 6) + NumberStr(this.results[0].w3_density, 7))
   .line(NumberStr((this.results[0].c1_unit).toString(), 6) + NumberStr(this.results[0].c1_density, 7))
   .line(NumberStr((this.results[0].c2_unit).toString(), 6) + NumberStr(this.results[0].c2_density, 7))
   .line(NumberStr((this.results[0].c3_unit).toString(), 6) + NumberStr(this.results[0].c3_density, 7))
   .line(NumberStr((this.results[0].mad1_unit).toString(), 6) + NumberStr(this.results[0].mad1_density, 7))
   .line(NumberStr((this.results[0].mad2_unit).toString(), 6) + NumberStr(this.results[0].mad2_density, 7))
   .line(NumberStr((this.results[0].mad3_unit).toString(), 6) + NumberStr(this.results[0].mad3_density, 7))
   .line(NumberStr((this.results[0].s1_unit).toString(), 6) + NumberStr(this.results[0].s1_density, 7))
   .line(NumberStr((this.results[0].s2_unit).toString(), 6) + NumberStr(this.results[0].s2_density, 7))
   .line(NumberStr((this.results[0].s3_unit).toString(), 6) + NumberStr(this.results[0].s3_density, 7))
   .line(NumberStr((this.results[0].g1_unit).toString(), 6) + NumberStr(this.results[0].g1_density, 7))
   .line(NumberStr((this.results[0].g2_unit).toString(), 6) + NumberStr(this.results[0].g2_density, 7))
   .line(NumberStr((this.results[0].g3_unit).toString(), 6) + NumberStr(this.results[0].g3_density, 7))
   .line(NumberStr((this.results[0].ad1_unit).toString(), 6) + NumberStr(this.results[0].ad1_density, 7))
   .line(NumberStr((this.results[0].ad2_unit).toString(), 6) + NumberStr(this.results[0].ad2_density, 7))
   .line(NumberStr((this.results[0].ad3_unit).toString(), 6) + NumberStr(this.results[0].ad3_density, 7))
