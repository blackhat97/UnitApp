...
export class ElementComponent implements OnInit {
  ...
  calc(ev) {
    ...
    if(name == 'w1_unit' || name == 'w2_unit' || name == 'w3_unit') {
      ...
      this.wDensity = (this.wUnit/(w1_unit/w1_density + w2_unit/w2_density + w3_unit/w3_density)).toFixed(4);
      ...
      this.cDensity = (this.cUnit/(c1_unit/c1_density + c2_unit/c2_density + c3_unit/c3_density)).toFixed(4);
      ...
      this.madDensity = (this.madUnit/(mad1_unit/mad1_density + mad2_unit/mad2_density + mad3_unit/mad3_density)).toFixed(4);
    }
  }
