...
export class ElementComponent implements OnInit {
  ...
  calc(ev) {
    ...
    if(name == 'w1_unit' || name == 'w2_unit' || name == 'w3_unit' || name == 'w1_density' || name == 'w2_density' || name == 'w3_density') {
    ...
    } else if(name == 'c1_unit' || name == 'c2_unit' || name == 'c3_unit' || name == 'c1_density' || name == 'c2_density' || name == 'c3_density') {
    ...
    } else if(name == 'mad1_unit' || name == 'mad2_unit' || name == 'mad3_unit' || name == 'mad1_density' || name == 'mad2_density' || name == 'mad3_density') {
