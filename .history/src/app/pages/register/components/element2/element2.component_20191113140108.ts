...
export class Element2Component implements OnInit {
  ...
  calc(ev) {
    ...
    if(name == 's1_unit' || name == 's2_unit' || name == 's3_unit') {
      ...
      this.sDensity = (this.sUnit/(s1_unit/s1_density + s2_unit/s2_density + s3_unit/s3_density)).toFixed(4);
      ...
      this.gDensity = (this.gUnit/(g1_unit/g1_density + g2_unit/g2_density + g3_unit/g3_density)).toFixed(4);
      ...
      this.adDensity = (this.adUnit/(ad1_unit/ad1_density + ad2_unit/ad2_density + ad3_unit/ad3_density)).toFixed(4);
    }
  }
