...
export class FinalComponent implements OnInit {
  ...
  submit() {
    ...
    if(this.formData.g1_unit == null) {
      this.formData.g1_unit = "";
    }
    if(this.formData.g2_unit == null) {
      this.formData.g2_unit = "";
    }
    if(this.formData.g3_unit == null) {
      this.formData.g3_unit = "";
    }
    ...
    if(this.formData.g1_density == null) {
      this.formData.g1_density = "";
    }
    if(this.formData.g2_density == null) {
      this.formData.g2_density = "";
    }
    if(this.formData.g3_density == null) {
      this.formData.g3_density = "";
    }
