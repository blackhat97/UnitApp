...
export class AppComponent {
  ...
  initializeApp() {
    ...
    this.platform.ready().then(() => {
      ...
      this.androidPermissions.checkPermission(this.androidPermissions.PERMISSION.UPDATE_DEVICE_STATS).then(
        result => console.log('Has permission?',result.hasPermission),
        err => this.androidPermissions.requestPermission(this.androidPermissions.PERMISSION.UPDATE_DEVICE_STATS)
      );
