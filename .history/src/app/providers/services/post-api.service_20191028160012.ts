...
export class PostApiService {
  ...
  addCompany(id, name) {
    return this.http.post(`${this.url}/company/${id}`, { headers: this.headers })
    .pipe(
      tap(res => {
        return res;
      }),
  ...
  addContractor(id, name) {
    return this.http.post(`${this.url}/contractor/${id}`, { headers: this.headers })
    .pipe(
      tap(res => {
        return res;
      }),
  ...
  addSite(id, name) {
    return this.http.post(`${this.url}/site/${id}`, { headers: this.headers })
    .pipe(
      tap(res => {
        return res;
      }),
