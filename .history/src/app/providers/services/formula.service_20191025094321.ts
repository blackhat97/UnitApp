...
export class FormulaService {
  ...
  */
  ...
  let value = ((((inputs.iPressure - inputs.ePressure) * this.commons.air_volume) / inputs.ePressure) / l18 * 100 - this.commons.pz - mix.aggregate).toFixed(2);
  return value;
  }
  ...
  */
    const c9 = mixs.w1_unit + mixs.w2_unit + mixs.w3_unit;
    // c9/c10+d9/d10+e9/e10+f9/f10+g9/g10+h9/h10+b9*10
    const j10 = ;
    const l26 = ;
    const l27 = ;
    let l28 = ;
