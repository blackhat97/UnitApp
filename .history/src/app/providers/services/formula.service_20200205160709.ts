  ...
  */
  volumeMass(inputs) { //단위용적질량
    ...
    */
    ...
    const l23 = (0.99997495*(1-Math.pow((l22-3.983035),2)*(l22+301.797)/(522528.9*(l22+69.34881)))).toFixed(6);
    let l23_num = Number(l23);
    let l17 = inputs.concrete - this.commons.mass; //콘크리트 질량
    let l18 = l16-(inputs.water-inputs.concrete)/l23_num; //콘크리트 용적
