...
export class PostApiService {
  ...
  updateCheck(id, bool) {
    console.log(id, bool);
    return this.http.put(`${this.url}/date-check/${id}`, bool, { headers: this.headers })
    .pipe(
      tap(res => {
        return res;
      }),
  ...
  addContractor(id, name) {
    const params = new HttpParams().set('name', name);
    return this.http.post(`${this.url}/contractor/${id}`, null, { headers: this.headers, params: params })
    .pipe(
      tap(res => {
        return res;
      }),
  ...
  addSite(id, name) {
    const params = new HttpParams().set('name', name);
    return this.http.post(`${this.url}/site/${id}`, null, { headers: this.headers, params: params })
    .pipe(
      tap(res => {
        return res;
      }),
  ...
  updateMemo(id, value) {
    return this.http.put(`${this.url}/memo/${id}`, value, { headers: this.headers })
    .pipe(
      tap(res => {
        return res;
      }),
