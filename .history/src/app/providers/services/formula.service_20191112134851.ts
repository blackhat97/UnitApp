...
export class FormulaService {
 ...
 theoryVolume(formData) {
  ...
  /*
  const c3 = this.formData.c1_unit || 0,
  c4 = this.formData.c1_unit || 0,
  c5 = this.formData.c1_unit || 0,
  d3 = this.formData.c1_unit || 1,
  d4 = this.formData.c1_unit || 1,
  d5 = this.formData.c1_unit || 1,
  f3 = this.formData.c1_unit || 0,
  ...
  i3 = this.formData.c1_unit || 0,
  i4 = this.formData.c2_unit || 0,
  i5 = this.formData.c3_unit || 0,
  j3 = this.formData.c1_density || 1,
  j4 = this.formData.c2_density || 1,
  j5 = this.formData.c3_density || 1;
  l3 = this.formData.c1_unit || 0,
  l4 = this.formData.c2_unit || 0,
  l5 = this.formData.c3_unit || 0,
  m3 = this.formData.c1_density || 1,
  m4 = this.formData.c2_density || 1,
  m5 = this.formData.c3_density || 1;
