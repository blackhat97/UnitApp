...
export class FormulaService {
 ...
 theoryVolume(formData) {

  const c3 = formData.c1_unit || 0,
  c4 = formData.c1_unit || 0,
  c5 = formData.c1_unit || 0,
  d3 = formData.c1_unit || 1,
  d4 = formData.c1_unit || 1,
  d5 = formData.c1_unit || 1,
  ...
  i3 = formData.c1_unit || 0,
  i4 = formData.c2_unit || 0,
  i5 = formData.c3_unit || 0,
  j3 = formData.c1_density || 1,
  j4 = formData.c2_density || 1,
  j5 = formData.c3_density || 1,
  l3 = formData.c1_unit || 0,
  l4 = formData.c2_unit || 0,
  l5 = formData.c3_unit || 0,
  m3 = formData.c1_density || 1,
  m4 = formData.c2_density || 1,
  m5 = formData.c3_density || 1,
  o3 = formData.c1_unit || 0,
  o4 = formData.c2_unit || 0,
  o5 = formData.c3_unit || 0,
  p3 = formData.c1_density || 1,
  p4 = formData.c2_density || 1,
  p5 = formData.c3_density || 1,
  r3 = formData.c1_unit || 0,
  r4 = formData.c2_unit || 0,
  r5 = formData.c3_unit || 0,
  s3 = formData.c1_density || 1,
  s4 = formData.c2_density || 1,
  s5 = formData.c3_density || 1;
