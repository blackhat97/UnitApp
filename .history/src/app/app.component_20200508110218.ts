...
import { Platform, IonRouterOutlet, ToastController, ModalController, NavController, Config } from '@ionic/angular';
  ...
  initTranslate() {
    ...
    this.storage.getLang().then(lang => {
      if (!lang && this.translate.getBrowserLang() !== undefined) {
        ...
        this.translate.use(lang || 'en'); // Establezca su idioma aquí
      }
